...
include_once "views/admin/layout/header.php" ?>
    <article>
        ...
        <form action="?ctr=save_update_loai" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="ten_loai" placeholder="tên hàng" value="<?=$ten_loai?>">
                    </div>
                </div>


            </div>
            <button class="btn" type="submit" name="btn_insert_loai">Cập nhập</button>
